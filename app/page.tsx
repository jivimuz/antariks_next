...
// (DIMODIFIKASI) Menambahkan techStack, partners, dan status form
const allContent = {
  id: {
    navLinks: [
      ...
      items: [
        {
          ...
          description:
            "Pengembangan web kustom, dari landing page hingga aplikasi web kompleks dengan React, Next.js, dan Node.js.",
        },
        {
          title: "Mobile Development",
          description:
            "Aplikasi mobile native (iOS/Android) dan cross-platform (React Native) yang intuitif dan berkinerja tinggi.",
        },
        {
          title: "Cloud & DevOps",
          description:
            "Solusi infrastruktur cloud yang skalabel, CI/CD, dan otomatisasi untuk memastikan aplikasi Anda berjalan lancar.",
        },
        {
          title: "UI/UX Design",
          description:
            "Merancang antarmuka yang indah dan fungsional, berfokus pada pengalaman pengguna yang tak terlupakan.",
        },
        {
          title: "Data Engineering",
          description:
            "Membangun pipeline data yang kokoh, gudang data, dan solusi analitik untuk memberdayakan keputusan bisnis.",
        },
        {
          title: "Konsultasi IT",
          description:
            "Memberikan wawasan strategis dan peta jalan teknologi untuk membantu bisnis Anda bertransformasi secara digital.",
        },
      ],
    },
    techStack: {
      ...
      subtitle:
        "Kami menguasai tumpukan teknologi modern untuk membangun solusi terbaik untuk Anda.",
    },
    products: {
    ...
    partners: {
      title: "Mitra Kami",
          subtitle:
              "Perusahaan yang menggunakan jasa kami dalam pengembangan aplikasi.",
          logos: [
        {
          src: "image/partners/pt1.png",
          alt: "Partner Logo 1",
        },
        {
          src: "image/partners/pt2.png",
          alt: "Client Logo 2",
        },
      ],
    },
    testimonials: {
      ...
      subtitle: "Kemitraan yang kami bangun adalah aset terbesar kami.",
    },
   location: {
            title: "Lokasi Kami",
            subtitle:
              "Temukan kami di pusat inovasi. Mampir untuk minum kopi dan diskusi.",
            hq: "Antariks HQ",
    ...
    contact: {
      title: "Mari Bicara",
      subtitle:
        "Punya ide brilian atau masalah kompleks? Kami siap membantu mewujudkannya.",
      form: {
        name: "Nama Anda",
  ...
  en: {
    ...
    hero: {
      ...
      subtitle:
        "We are your digital architects, transforming complex ideas into elegant, scalable, and secure software.",
      cta: "Consult Now",
    },
    services: {
      title: "Our Featured Services",
      subtitle:
        "We provide end-to-end technology solutions to drive your business growth.",
      items: [
        {
          title: "Web Development",
          description:
            "Custom web development, from landing pages to complex web apps using React, Next.js, and Node.js.",
        },
        {
          title: "Mobile Development",
          description:
            "Intuitive and high-performance native (iOS/Android) and cross-platform (React Native) mobile apps.",
        },
        {
          title: "Cloud & DevOps",
          description:
            "Scalable cloud infrastructure solutions, CI/CD, and automation to ensure your application runs smoothly.",
        },
        {
          title: "UI/UX Design",
          description:
            "Designing beautiful and functional interfaces, focusing on an unforgettable user experience.",
        },
        {
          title: "Data Engineering",
          description:
            "Building robust data pipelines, data warehouses, and analytics solutions to empower business decisions.",
        },
        {
          title: "IT Consulting",
          description:
            "Providing strategic insights and a technology roadmap to help your business digitally transform.",
        },
      ],
    },
    techStack: {
      ...
      subtitle:
        "We master the modern technology stack to build the best solutions for you.",
    },
    products: {
      title: "Our Products & Portfolio",
      subtitle: "Real-world examples of how we turn ideas into solutions.",
    },
    about: {
      title: "About",
    ...
    partners: {
            title: "Our Partners",
            subtitle: "Companies that use our services in app development.",
      logos: [
        {
          src: "image/partners/pt1.png",
          alt: "Partner Logo 1",
    ...
    testimonials: {
      ...
      subtitle: "The partnerships we build are our greatest asset.",
    },
     location: {
            title: "Our Location",
            subtitle:
              "Find us at the innovation hub. Stop by for coffee and a discussion.",
            hq: "Antariks HQ",
            address: "St. S.A Tirtayasa No.123 Cirebon",
    ...
    contact: {
      title: "Let's Talk",
      subtitle:
        "Have a brilliant idea or a complex problem? We are ready to help bring it to life.",
      form: {
        name: "Your Name",
        namePlaceholder: "John Doe",
        email: "Email",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 mb-1">
                    <strong>{t.location.email}</strong> antariks.corp@gmail.com
                  </p>
                  <p className="text-gray-400">
                    <strong>{t.location.phone}</strong> +62 821 2074 1970
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:w-1/2 w-full h-80 lg:h-96">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d632.2972372450716!2d108.52638230611186!3d-6.711728397466543!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6ee3004c0bdb1b%3A0xe3d7a1cd0042f4f1!2sAntariks!5e0!3m2!1sid!2sid!4v1763121831675!5m2!1sid!2sid"
              width="100%"
              height="100%"
              style={{ border: 0 }}
